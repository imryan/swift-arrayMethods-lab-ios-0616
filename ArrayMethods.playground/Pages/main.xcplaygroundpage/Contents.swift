...
if (reverseEmptyArray.isEmpty) {
    print("I can't find anything in this array man.")
}
/*: question5
...
for (index, day) in daysOfTheWeek.enumerate() {
    ...
    daysOfTheWeek.insert(day, atIndex: index)
}
/*: question9
...
if (daysOfTheWeek.count > 5) {
    daysOfTheWeek.removeFirst() // For those who start their week on Sunday, otherwise `removeLast(2)`
    daysOfTheWeek.removeLast()
}
